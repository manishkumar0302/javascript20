    ...
    <>
      ...
      <main className="main">
        ...
        <article>
          ...
          <p>
            The popularity of the shorts led to Cartoon Network commissioning a
            first season of Johnny Bravo, consisting of 13 episodes. The crew of
            the first season consisted of several writers, animators, and
            directors from World Premiere Toons, including Seth MacFarlane,
            Butch Hartman, Steve Marmel, and John McIntyre. Veteran animator
            Joseph Barbera also served as a creative consultant and mentor for
            the first season. Partible stated in a 1997 interview the goal of
            the series was to have "animation reminiscent of the old
          ...
          <h3>RETOOL</h3>
          <p>
            After the first season, Johnny Bravo was put on hiatus, until it was
            picked up for an unexpected second season in 1999. Van Partible left
            production and Kirk Tingblad took over as director, leading to a
            major retooling in the show's visual style, tone, humor, and
            characters. The show retained this format for the third season.
          </p>
          <p>
            The series sat in limbo once again until it was renewed for a fourth
            season in 2003, which aired in 2004. The final season of the series
            returned to the humor of the original shorts and first season of the
            series, although the Jungle Boy character from the first season
            never returned.
          </p>
        </article>
        <h2>EPISODES</h2>
        ...
        <p>
          The title character is considered "iconic", and his catchphrases are
          relatively common in popular culture.
        </p>
        <p>
          The show's creative team went on to create many successful television
          series throughout the 1990s and 2000s, including writer Seth
          MacFarlane, creator of the popular animated series Family Guy. Shortly
          after the series' first season was completed, writer/director Butch
          Hartman left to work on Nickelodeon's Oh Yeah! Cartoons, from which
          those shorts spun off his own success, The Fairly OddParents. Steve
          Marmel, writer for Johnny Bravo, has been a producer and writer for
          The Fairly OddParents since its premiere in 2001. In addition to
          Johnny Bravo, director John McIntyre directed episodes of several
          other Cartoon Cartoons, and more recently served as a supervising
        ...
        <p>
          ...
          2001. It was hosted by Johnny Bravo, along with some infrequent guest
          stars such as Chicken (from Cow and Chicken). Callers would write into
          the show via mail or through the Cartoon Network website to call the
          show and request a cartoon from Cartoon Network's cartoon library,
          which would then be played, with an exception of half-hour-long shows.
          Notably, one caller of the show named Jennifer requested an episode of
          Dragon Ball Z. Being that it was a half-hour long, Johnny regretfully
          had to fast-forward through the entire episode with Johnny providing
          only expositional commentary. Afterward, Johnny apologized to the
          caller for the inconvenience.
        </p>
        <p>
          After the series ended, a spin-off of JBVO named Toon FM was launched
          in Europe. The series had a few unique changes, such as a Godzilla
          presenting the weather.
        </p>
        <p>
          There was also a similar spin-off of the JBVO concept itself entitled
          Viva Las Bravo, a summer block that aired from 2005 to 2006 on certain
          European variants of Cartoon Network. Every day Johnny would announce
          three cartoons, with the one getting the highest votes via email or on
          CartoonNetworkHQ.net would be shown for two hours the next day. He
          would also constantly appear in commercial breaks, cracking jokes or
          answering humorous emails and phone calls.
        </p>
        <h2>MEDIA</h2>
        <h3>COMICS</h3>
        <p>
          In February 2013, IDW Publishing announced a partnership with Cartoon
          Network to produce comics based on its properties. Johnny Bravo was
          one of the titles announced to be published.
        </p>
        <h3>VIDEO GAMES</h3>
        <p>
          A video game titled Johnny Bravo In The Hukka Mega Mighty Ultra
          Extreme Date-O-Rama! was released on June 9, 2009 for the Nintendo DS
          and PlayStation 2. The PlayStation 2 version was released exclusively
          in Europe and Australia by Blast Entertainment, while the DS version
          was released in North America by MumboJumbo.
        </p>
        <p>
          Characters from Johnny Bravo are featured in the Cartoon Network games
          Cartoon Network: Block Party, Cartoon Network Racing, Cartoon Network
          Speedway, and Cartoon Network Universe: FusionFall.
        </p>
        <h3>CANCELLED FILM</h3>
        <p>
          It was reported in 2002 that Warner Bros. had secured the rights for a
          live-action Johnny Bravo feature film as a potential starring vehicle
          for Dwayne "The Rock" Johnson". However, no further developments
          regarding this project have been announced since.
        </p>
      </main>
